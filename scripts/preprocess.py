...
train_base_path = '/Users/tarekatbi/Desktop/ML/env/data/GTSRB_Final_Training_Images/Final_Training/Images'
test_base_path = '/Users/tarekatbi/Desktop/ML/env/data/GTSRB_Final_Test_Images/Final_Test/Images'
output_base_dir = '/Users/tarekatbi/Desktop/ML/env/data/GTSRB_Preprocessed'
train_csv = '/Users/tarekatbi/Desktop/ML/env/data/GT-final_train.csv'  # Supposant que vous avez un fichier CSV pour l'entraînement
test_csv = '/Users/tarekatbi/Desktop/ML/env/data/GT-final_test.csv'
...
def preprocess_class(base_path, csv_path, output_base_dir, class_dirs=None):
    if class_dirs:
        for class_dir in class_dirs:
            process_single_class(base_path, class_dir, output_base_dir)
    else:
        process_single_class(base_path, '', output_base_dir, csv_path=csv_path)

def process_single_class(base_path, class_dir, output_base_dir, csv_path=None):
    if csv_path is None:
    ...
    if class_dir:
        ...
        output_class_dir = output_base_dir
    ...
    if os.path.exists(csv_path):
        ...
        for index, row in df.iterrows():
            ...
            class_id = row['ClassId'] if 'ClassId' in row else 'test'  # Utiliser 'test' pour les images de test
            ...
            resized_image = cropped_image.resize(img_size, Image.LANCZOS)
...
# Prétraiter les images de formation
preprocess_class(train_base_path, None, output_train_dir, class_dirs)

# Prétraiter les images de test
preprocess_class(test_base_path, test_csv, output_test_dir)
